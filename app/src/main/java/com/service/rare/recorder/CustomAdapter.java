...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            play_image = (ImageView) view.findViewById(R.id.imageView);
            ...
            play_image.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String filepath = MainActivity2.path.toString()+"/"+MainActivity2.files[getAdapterPosition()]+".mp3" ;
                    try {
                        boolean isPlaying=MainActivity2.playRecording(filepath,v,getAdapterPosition(),prev_image);
